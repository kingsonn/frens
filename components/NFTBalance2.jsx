...
function NFTBalance2(props) {
  ...
  const { data: NFTBalances , getNFTBalances} = useNFTBalances({address: props.address, chain:"0x4"});
  ...
  return (
    <div style={{ padding: "15px", maxWidth: "1030px", width: "100%" , margin:"0% 8%"}}>
